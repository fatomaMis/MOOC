...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { attachment: @lecture.attachment, content: @lecture.content, course: @lecture.course } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { attachment: @lecture.attachment, content: @lecture.content, course: @lecture.course } }
